...
setwd("C:\\Users\\user22\\Desktop\\2024EST\\modification\\adddata\\tpm\\240822 Selected Single-Copy Genes and Normalization\\Heatmap Creation")
...
ggsave('40single_copy_gene_heatmap_MT.pdf', df1, width = 14, height = 2.75)
